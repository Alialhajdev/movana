...
export const dict: Dict = {
  ...
  offer_view: { ar: "عرض التفاصيل", en: "View details" },
  // addresses
  address: { ar: "العنوان", en: "Address" },
  addresses: { ar: "العناوين", en: "Addresses" },
  add_address: { ar: "إضافة عنوان جديد", en: "Add new address" },
  select_address: { ar: "اختر عنوان التوصيل", en: "Select delivery address" },
  no_addresses: { ar: "لا توجد عناوين محفوظة", en: "No saved addresses" },
  address_label: { ar: "اسم العنوان (المنزل، العمل…)", en: "Label (Home, Work…)" },
  city: { ar: "المدينة", en: "City" },
  district: { ar: "الحي", en: "District" },
  street: { ar: "الشارع", en: "Street" },
  address_details: { ar: "تفاصيل إضافية", en: "Additional details" },
  map_url: { ar: "رابط الموقع على الخريطة", en: "Map location URL" },
  map_url_hint: { ar: "الصق رابط الموقع من تطبيق الخرائط", en: "Paste a Google Maps share link" },
  pick_on_map: { ar: "تحديد الموقع على الخريطة", en: "Pick location on map" },
  open_map: { ar: "فتح الخريطة", en: "Open map" },
  use_address: { ar: "استخدم هذا العنوان", en: "Use this address" },
  // settings
  admin_settings: { ar: "إعدادات الموقع", en: "Site Settings" },
  site_logo: { ar: "شعار الموقع", en: "Site logo" },
  logo_text: { ar: "نص الشعار", en: "Logo text" },
  logo_url: { ar: "رابط صورة الشعار (اختياري)", en: "Logo image URL (optional)" },
  theme_preset: { ar: "لون السمة", en: "Theme color" },
  theme_mode: { ar: "وضع العرض", en: "Display mode" },
